...
### remove already know outliers
known_outliers=["TOTAL", "LAVORATO JOHN J", "MARTIN AMANDA K", "URQUHART JOHN A", "MCCLELLAN GEORGE", "SHANKMAN JEFFREY A", "WHITE JR THOMAS E", "PAI LOU L", "HIRKO JOSEPH"]
for name in known_outliers:
    datadict.pop(name)

usable_datapoints=len(data_dict)
# print usable_datapoints

### Task 3: Create new feature(s)
### elaborate existing features:
...
# print "number of financial_features: ", len(financial_features)
